...
export class ListArtisteComponent implements OnInit {
  ...
  constructor(private dialogService: NbDialogService, private httpClient: HttpClient, private service: SmartTableData, private usersService: UsersService,
  ...
  open(u: users) {
    /* this.r.navigate(['/pages/layout/dialog/' + u.id]);
*/
    this.dialogService.open(DialogComponent, {
      context: {
        title: 'This is a title passed to the dialog component ' +u.id,
      },
    });
  }
