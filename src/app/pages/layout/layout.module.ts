...
import { DeezerStatPaysComponent } from './details-mgmnt/deezer-details/deezer-stat-pays/deezer-stat-pays.component';
import { DeezerStatAbonnementComponent } from './details-mgmnt/deezer-details/deezer-stat-abonnement/deezer-stat-abonnement.component';
import { DeezerStatDateComponent } from './details-mgmnt/deezer-details/deezer-stat-date/deezer-stat-date.component';
import { DeezerStatChansonComponent } from './details-mgmnt/deezer-details/deezer-stat-chanson/deezer-stat-chanson.component';
import localeFr from '@angular/common/locales/fr';
import { registerLocaleData } from '@angular/common';
import { TotalDetailsComponent } from './details-mgmnt/total-details/total-details.component';
import { TotalStatComponent } from './details-mgmnt/total-details/total-stat/total-stat.component';
import { TotalStatAbonnementComponent } from './details-mgmnt/total-details/total-stat-abonnement/total-stat-abonnement.component';
import { TotalStatChansonComponent } from './details-mgmnt/total-details/total-stat-chanson/total-stat-chanson.component';
import { TotalStatDateComponent } from './details-mgmnt/total-details/total-stat-date/total-stat-date.component';
import { TotalStatPaysComponent } from './details-mgmnt/total-details/total-stat-pays/total-stat-pays.component';
import { TotalStatPlateformeComponent } from './details-mgmnt/total-details/total-stat-plateforme/total-stat-plateforme.component';
import { OrangeStatDetailsComponent } from './details-mgmnt/orange-details/orange-stat-details/orange-stat-details.component';
import { OrangeModalsComponent } from './details-mgmnt/orange-details/orange-modals/orange-modals.component';
import { TotalStatCategoryComponent } from './details-mgmnt/total-details/total-stat-category/total-stat-category.component';
...
@NgModule({
  ...
  declarations: [
    ...
    DeezerStatComponent,
    DeezerStatPaysComponent,
    DeezerStatAbonnementComponent,
    DeezerStatDateComponent,
    DeezerStatChansonComponent,
    TotalDetailsComponent,
    TotalStatComponent,
    TotalStatAbonnementComponent,
    TotalStatChansonComponent,
    TotalStatDateComponent,
    TotalStatPaysComponent,
    TotalStatPlateformeComponent,
    OrangeStatDetailsComponent,
    OrangeModalsComponent,
    TotalStatCategoryComponent,
  ],
  providers: [
    NewsService,
