...
export class OrangeStatChansonComponent implements OnInit {
          ...
          this.detaisSerivce.getStatChansonById(idUser).subscribe(data=>{
            ...
            setTimeout(function() { (function ($) {
              $(document).ready(function() {
                $('#table-orange-stat-chanson').DataTable({
  ...
  exportexcel(): void {
    ...
    let element = document.getElementById('table-orange-stat-chanson');
  ...
  public openPDF():void {
    let DATA = document.getElementById('table-orange-stat-chanson');
