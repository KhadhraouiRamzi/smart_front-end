  ...
  @Component({
    selector: 'ngx-believe-stat-plateforme',
    templateUrl: './believe-stat-plateforme.component.html',
    styleUrls: ['./believe-stat-plateforme.component.scss']
  })
  export class BelieveStatPlateformeComponent implements OnInit {
    ...
    fileName = 'Liste plateforme.xlsx';
    details: details;
    st: any;
    ...
    ngOnInit(): void {
      ...
      this.believeSerivce.getStatPlateformeBelieve().subscribe(
        res => {
          let role = this.token.getUser()['roles'];
          let idUser = this.token.getUser().id;
          if (role == "ROLE_ARTISTE") {
            this.believeSerivce.getStatPlateformeBelieveById(idUser).subscribe(data => {
              this.details = data;
    ...
    exportexcel(): void {
      ...
      let element = document.getElementById('table-believe-stat');
    ...
    public openPDF(): void {
      let DATA = document.getElementById('table-believe-stat');
