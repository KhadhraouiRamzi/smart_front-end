  ...
  @Component({
    selector: 'ngx-believe-stat-pays',
    templateUrl: './believe-stat-pays.component.html',
    styleUrls: ['./believe-stat-pays.component.scss']
  })
  export class BelieveStatPaysComponent implements OnInit {
    ...
    ngOnInit(): void {
      ...
      this.believeSerivce.getStatPaysBelieve().subscribe(
        res => {
          let role = this.token.getUser()['roles'];
          let idUser = this.token.getUser().id;
          if (role == "ROLE_ARTISTE") {
            this.believeSerivce.getStatPaysBelieveById(idUser).subscribe(data => {
              this.details = data;
              ...
              setTimeout(function () {
                (function ($) {
                  $(document).ready(function () {
                    $('#table-believe-stat-pays').DataTable({
  ...
  */
    ...
    exportexcel(): void {
      ...
      let element = document.getElementById('table-believe-stat-pays');
    ...
    public openPDF(): void {
      let DATA = document.getElementById('table-believe-stat-pays');
