...
@Component({
  selector: 'ngx-deezer-stat-chanson',
  templateUrl: './deezer-stat-chanson.component.html',
  styleUrls: ['./deezer-stat-chanson.component.scss']
})
export class DeezerStatChansonComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.deezerSerivce.getStatChansonDeezer().subscribe(
      res => {
        let role = this.token.getUser()['roles'];
        let idUser = this.token.getUser().id;
        if (role == "ROLE_ARTISTE") {
          this.deezerSerivce.getStatChansonDeezerById(idUser).subscribe(data => {
            this.details = data;
            ...
            setTimeout(function () {
              (function ($) {
                $(document).ready(function () {
                  $('#table-deezer-stat-chanson').DataTable({
  ...
  exportexcel(): void {
    ...
    let element = document.getElementById('table-deezer-stat-chanson');
  ...
  public openPDF(): void {
    let DATA = document.getElementById('table-deezer-stat-chanson');
