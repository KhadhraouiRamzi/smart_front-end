...
@Component({
  selector: 'ngx-deezer-stat-pays',
  templateUrl: './deezer-stat-pays.component.html',
  styleUrls: ['./deezer-stat-pays.component.scss']
})
export class DeezerStatPaysComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.deezerSerivce.getStatPaysDeezer().subscribe(
      res => {
        let role = this.token.getUser()['roles'];
        let idUser = this.token.getUser().id;
        if (role == "ROLE_ARTISTE") {
          this.deezerSerivce.getStatPaysDeezerById(idUser).subscribe(data => {
            this.details = data;
            ...
            setTimeout(function () {
              (function ($) {
                $(document).ready(function () {
                  $('#table-deezer-stat-pays').DataTable({
  ...
  exportexcel(): void {
    ...
    let element = document.getElementById('table-deezer-stat-pays');
  ...
  public openPDF(): void {
    let DATA = document.getElementById('table-deezer-stat-pays');
