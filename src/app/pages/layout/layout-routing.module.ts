...
const routes: Routes = [{
  ...
  children: [
    ...
    {
      path: 'total-stat',
      component: TotalStatComponent,
    },
    {
      path: 'total-stat-category',
      component: TotalStatCategoryComponent,
    },
    {
      path: 'total-stat-platefrome',
      component: TotalStatPlateformeComponent,
    },
    {
      path: 'total-stat-chanson',
      component: TotalStatChansonComponent,
    },
    {
      path: 'total-stat-date',
      component: TotalStatDateComponent,
    }, 
    
    {
      path: 'orange-stat-details/:id',
      component: OrangeStatDetailsComponent,
    },
    {
      path: 'Historique',
    ...
    {
      path: 'deezer-stat-chanson',
      component: DeezerStatChansonComponent,
    },
    {  
      path: 'deezer-stat-abonnement',
      component: DeezerStatAbonnementComponent,
    },
    {  
      path: 'deezer-stat-date',
      component: DeezerStatDateComponent,
    },
    {  
      path: 'deezer-stat-pays',
      component: DeezerStatPaysComponent,
    },
    {
      path: 'believe',
